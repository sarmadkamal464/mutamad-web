											...
											<div class="row">
												<div class="wt-starthiringhold wt-innerspace wt-haslayout">
													...
													<div class="col-12 col-sm-12 col-md-12 col-lg-5 float-right">
														<div class="wt-howtoworkimg">
															<figure>
																 <img src='{{ asset("images/work/img-01.jpg" ) }}' alt="img description">
															</figure>
														</div>
													</div>
												</div>
												<div class="wt-starthiringhold wt-innerspace wt-haslayout">
													...
													<div class="col-12 col-sm-12 col-md-12 col-lg-5 float-left">
														<div class="wt-howtoworkimg">
															<figure>
																 <img src='{{ asset("images/work/img-02.jpg" ) }}' alt="img description">
															</figure>
														</div>
													</div>
												</div>
												<div class="wt-starthiringhold wt-innerspace wt-haslayout">
													...
													<div class="col-12 col-sm-12 col-md-12 col-lg-5 float-right">
														<div class="wt-howtoworkimg">
															<figure>
																 <img src='{{ asset("images/work/img-03.jpg" ) }}' alt="img description">
															</figure>
														</div>
													</div>
												</div>
